        ...
        <div class="jumbotron-wrapper">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 d-flex">
                    <img src="../../asset/img/backgrounds/bg_staking.png" class="align-self-center" alt="">
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mt-xl-0 mt-5 text-lg-left text-center px-1 p-lg-0">
                    <h3 class="color-yellow mb-3">Duckie Land Staking+</h3>
